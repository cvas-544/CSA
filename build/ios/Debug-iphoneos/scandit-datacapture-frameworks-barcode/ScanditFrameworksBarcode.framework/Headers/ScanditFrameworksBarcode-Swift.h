...
SWIFT_CLASS("_TtC24ScanditFrameworksBarcode18BarcodeBatchModule")
@interface BarcodeBatchModule : NSObject
...
@interface BarcodeBatchModule (SWIFT_EXTENSION(ScanditFrameworksBarcode)) <DeserializationLifeCycleObserver>
...
@interface BarcodeBatchModule (SWIFT_EXTENSION(ScanditFrameworksBarcode)) <SDCBarcodeBatchDeserializerDelegate>
- (void)barcodeBatchDeserializer:(SDCBarcodeBatchDeserializer * _Nonnull)deserializer didStartDeserializingMode:(SDCBarcodeBatch * _Nonnull)mode fromJSONValue:(SDCJSONValue * _Nonnull)jsonValue;
- (void)barcodeBatchDeserializer:(SDCBarcodeBatchDeserializer * _Nonnull)deserializer didFinishDeserializingMode:(SDCBarcodeBatch * _Nonnull)mode fromJSONValue:(SDCJSONValue * _Nonnull)jsonValue;
- (void)barcodeBatchDeserializer:(SDCBarcodeBatchDeserializer * _Nonnull)deserializer didStartDeserializingSettings:(SDCBarcodeBatchSettings * _Nonnull)settings fromJSONValue:(SDCJSONValue * _Nonnull)jsonValue;
- (void)barcodeBatchDeserializer:(SDCBarcodeBatchDeserializer * _Nonnull)deserializer didFinishDeserializingSettings:(SDCBarcodeBatchSettings * _Nonnull)settings fromJSONValue:(SDCJSONValue * _Nonnull)jsonValue;
- (void)barcodeBatchDeserializer:(SDCBarcodeBatchDeserializer * _Nonnull)deserializer didStartDeserializingBasicOverlay:(SDCBarcodeBatchBasicOverlay * _Nonnull)overlay fromJSONValue:(SDCJSONValue * _Nonnull)jsonValue;
- (void)barcodeBatchDeserializer:(SDCBarcodeBatchDeserializer * _Nonnull)deserializer didFinishDeserializingBasicOverlay:(SDCBarcodeBatchBasicOverlay * _Nonnull)overlay fromJSONValue:(SDCJSONValue * _Nonnull)jsonValue;
- (void)barcodeBatchDeserializer:(SDCBarcodeBatchDeserializer * _Nonnull)deserializer didStartDeserializingAdvancedOverlay:(SDCBarcodeBatchAdvancedOverlay * _Nonnull)overlay fromJSONValue:(SDCJSONValue * _Nonnull)jsonValue;
- (void)barcodeBatchDeserializer:(SDCBarcodeBatchDeserializer * _Nonnull)deserializer didFinishDeserializingAdvancedOverlay:(SDCBarcodeBatchAdvancedOverlay * _Nonnull)overlay fromJSONValue:(SDCJSONValue * _Nonnull)jsonValue;
@end
...
SWIFT_CLASS("_TtC24ScanditFrameworksBarcode45FrameworksBarcodeBatchAdvancedOverlayListener")
@interface FrameworksBarcodeBatchAdvancedOverlayListener : NSObject <SDCBarcodeBatchAdvancedOverlayDelegate>
- (UIView * _Nullable)barcodeBatchAdvancedOverlay:(SDCBarcodeBatchAdvancedOverlay * _Nonnull)overlay viewForTrackedBarcode:(SDCTrackedBarcode * _Nonnull)trackedBarcode SWIFT_WARN_UNUSED_RESULT;
- (SDCAnchor)barcodeBatchAdvancedOverlay:(SDCBarcodeBatchAdvancedOverlay * _Nonnull)overlay anchorForTrackedBarcode:(SDCTrackedBarcode * _Nonnull)trackedBarcode SWIFT_WARN_UNUSED_RESULT;
- (SDCPointWithUnit)barcodeBatchAdvancedOverlay:(SDCBarcodeBatchAdvancedOverlay * _Nonnull)overlay offsetForTrackedBarcode:(SDCTrackedBarcode * _Nonnull)trackedBarcode SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC24ScanditFrameworksBarcode42FrameworksBarcodeBatchBasicOverlayListener")
@interface FrameworksBarcodeBatchBasicOverlayListener : NSObject <SDCBarcodeBatchBasicOverlayDelegate>
- (SDCBrush * _Nullable)barcodeBatchBasicOverlay:(SDCBarcodeBatchBasicOverlay * _Nonnull)overlay brushForTrackedBarcode:(SDCTrackedBarcode * _Nonnull)trackedBarcode SWIFT_WARN_UNUSED_RESULT;
- (void)barcodeBatchBasicOverlay:(SDCBarcodeBatchBasicOverlay * _Nonnull)overlay didTapTrackedBarcode:(SDCTrackedBarcode * _Nonnull)trackedBarcode;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC24ScanditFrameworksBarcode30FrameworksBarcodeBatchListener")
@interface FrameworksBarcodeBatchListener : NSObject <SDCBarcodeBatchListener>
- (void)barcodeBatch:(SDCBarcodeBatch * _Nonnull)barcodeBatch didUpdate:(SDCBarcodeBatchSession * _Nonnull)session frameData:(id <SDCFrameData> _Nonnull)frameData;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class SDCBarcodeCountStatusProviderCallback;

SWIFT_CLASS("_TtC24ScanditFrameworksBarcode36FrameworksBarcodeCountStatusProvider")
@interface FrameworksBarcodeCountStatusProvider : NSObject <SDCBarcodeCountStatusProvider>
- (void)statusRequestedForBarcodes:(NSArray<SDCTrackedBarcode *> * _Nonnull)barcodes callback:(SDCBarcodeCountStatusProviderCallback * _Nonnull)callback;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (void)sparkScanView:(SDCSparkScanView * _Nonnull)view didChangeState:(SDCSparkScanViewState)viewState;
